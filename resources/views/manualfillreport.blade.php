...
<body itemtype="https://schema.org/WebPage" itemscope="itemscope"
    ...
    <div class="hfeed site" id="page">
        ...
        <div style="padding-inline:10%;">
            ...
            <!-- make details and form section on detail Search Result for VIN #: 1GKDT13W21K226341
Make: GMC
Vehicle Type: MPV
Model Year: 2001
Body Style: SPORT UTILITY 4-DR
$33.00
and  form feilds is First name
First Name
...
Phone
Phone
Submit make it with white background and content theeme is indigo  -->
            ...
            .details-container .form-group label {
                display: block;
                margin-bottom: 5px;
                font-weight: 600;
                color: indigo;
            ...
            .details-container .form-group input {
                width: 100%;
                padding: 10px;
            ...
            .details-container .form-group button {
            ...
            <div class="details-container">
                ...
                <p style="margin-bottom: 1rem;">Search Result for VIN #: <span
                        style="font-weight: 600;">{{isset($vid) ? $vid : ''}}</span>
                </p>
                ...
                <form id="payment-form">
                    ...
                    <br>
                    <!-- Stripe Card Element -->
                    <label for="package" class="" style="padding-bottom:15px; color:#0093B1FFc;">Enter Stripe Payment
                        Details </label> <br />
                    <div id="card-element"
                        style="padding: 20px; border: 1px solid indigo; border-color: border-radius: 5px; background-color: #FAF7FFFF;">
                ...
                form.addEventListener('submit', async (event) => {
                    ...
                    if (error) {
                        ...
                        const vid = <?php echo json_encode($vid); ?>;
                        const vtype = <?php echo json_encode($vtype); ?>;
                        ...
                        if (!pkg || !fname || !lname || !email || !phone) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <hr>
                    <h6 class="" style="color:grey;"> Your Request Is Under Review.</h6>
                </div>
                <br>
            </div>
        </div>
